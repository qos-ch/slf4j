...
- In case your are asked for an opinion, do not modify files. Modify
  files only if asked to do so.

- If you suspect a typo in the instructions, ask for clarifications
  before proceeding.
